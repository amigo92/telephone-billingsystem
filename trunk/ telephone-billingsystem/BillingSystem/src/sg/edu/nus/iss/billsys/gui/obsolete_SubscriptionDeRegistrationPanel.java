...
public class obsolete_SubscriptionDeRegistrationPanel extends JPanel {
    ...
    public obsolete_SubscriptionDeRegistrationPanel (BillingWindow window) {   
    	 initialize(window);	
    }
    public obsolete_SubscriptionDeRegistrationPanel (BillingWindow window, String accountNo) {
